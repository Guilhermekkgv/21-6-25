...
function Linux.Create(config)
    ...
    function LinuxLib.Tab(config)
        ...
        local function SelectTab()
            ...
            for _, child in pairs(Container:GetChildren()) do
                if child:IsA("Frame") then
                    local originalBgTransparency = 0
        ...
        Tabs[tabIndex] = {
            ...
            Elements = {},
            IsDefault = config.Default or false
        }
        
        if DefaultTab == tabIndex or (not DefaultTab and tabOrder == 1) then
            CurrentTab = tabIndex
            TabContent.Visible = true
            TitleFrame.Visible = true
            TabText.TextColor3 = Color3.fromRGB(255, 255, 255)
        ...
        function TabElements.Paragraph(config)
            ...
            local function SetContent(newContent)
                Content.Text = ProcessLineBreaks(newContent)
            end
